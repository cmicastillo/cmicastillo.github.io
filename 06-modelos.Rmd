...
```{r cross-asig, results='asis', echo=FALSE}
...
```{r cross-tipo, results='asis', echo=FALSE}
...
```{r modelos-socioec, results='asis', echo=FALSE}
...
```{r odds-socioec, results='asis', echo=FALSE, fig.cap='Distribución de coeficientes del Modelo 5 en unidades odds-ratio para dimensión socioeconómica y demográfica'}
...
```{r modelos-acad, results='asis', echo=FALSE}
cohorte_m04 <- base_4 %>%
...
```{r modelos-inst, results='asis', echo=FALSE}
cohorte_m05 <- base_4 %>%
  select(tipo_inst,
         RAMA_EDUCACIONAL,
         GRUPO_DEPENDENCIA,
...
```{r grid-odds, results='asis', echo=FALSE, fig.align='center', fig.cap='Distribución de coeficientes de los Modelos 9 y 13 en unidades odds-ratio para dimensiones académica e institucional'}
